...
SELECT
  ...
  min_map_math.map_term AS min_map_math_term,
  min_map_math.map_percentile AS min_map_math_percentile,
  min_map_reading.map_term AS min_map_reading_term,
  min_map_reading.map_percentile AS min_map_reading_percentile,
