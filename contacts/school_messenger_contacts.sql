/******************************************************************************
* school_messenger_contacts.sql
* 
* NOTE: Be sure to update the enrollment entry and leave dates in the WHERE
* clause at the end of this query.
*******************************************************************************
* Author: Patrick Yoho
* Last Updated: 8/9/18 by Patrick Yoho
*
...
SELECT DISTINCT
  local_student_id AS "student_sis_local_id",
  sessions.site_id,
  ...
  codes.language.code_translation AS "language",

  legal_guardian_1.contact_id AS primary_guardian_id,
  legal_guardian_1.first_name AS guardian_1_first_name,
  legal_guardian_1.last_name AS guardian_1_last_name,
  legal_guardian_1.email_address AS guardian_1_email,
  legal_guardian_1.cell_phone_number AS guardian_1_phone_number,
  legal_guardian_1.contact_type AS guardian_1_relation,
  legal_guardian_1.home_phone_number AS guardian_1_home_phone_number,

  legal_guardian_2.first_name AS guardian_2_first_name,
  legal_guardian_2.last_name AS guardian_2_last_name,
  legal_guardian_2.email_address AS guardian_2_email,
  legal_guardian_2.cell_phone_number AS guardian_2_phone_number,
  legal_guardian_2.contact_type AS guardian_2_relation,
  legal_guardian_2.home_phone_number AS guardian_2_home_phone_number,

  emergency_contact_1.first_name AS emergency_contact_1_first_name,
  emergency_contact_1.last_name AS emergency_contact_1_last_name,
  emergency_contact_1.cell_phone_number AS emergency_contact_1_mobile_phone_number,
  emergency_contact_1.home_phone_number AS emergency_contact_1_home_phone_number,
  emergency_contact_1.email_address AS emergency_contact_1_email,
  emergency_contact_1.contact_type AS emergency_contact_1_relationship,

  emergency_contact_2.first_name AS emergency_contact_2_first_name,
  emergency_contact_2.last_name AS emergency_contact_2_last_name,
  emergency_contact_2.cell_phone_number AS emergency_contact_2_mobile_phone_number,
  emergency_contact_2.home_phone_number AS emergency_contact_2_home_phone_number,
  emergency_contact_2.email_address AS emergency_contact_2_email,
  emergency_contact_2.contact_type AS emergency_contact_2_relationship
...
FROM student_session_aff AS enrollments
  ...
  -- get a student's home language
  LEFT JOIN public.student_language ON stud.student_id = student_language.student_id
  LEFT JOIN codes.language ON public.student_language.home_language = codes.language.code_id
...
WHERE
  ...
  -- use the following during the school year
--   AND enrollments.entry_date <= current_date
--   AND enrollments.leave_date > current_date
  -- use the following before the school year for SY19 for CA
  AND enrollments.entry_date <= '2018-08-15'
  AND enrollments.leave_date > '2018-08-15'
    -- use the following before the school year for SY19 for WA
--   AND enrollments.entry_date <= '2018-08-21'
--   AND enrollments.leave_date > '2018-08-21'
